...
def main(args: argparse.Namespace) -> float:
    ...
    X = dataset.data
    t = dataset.target
    # Appending a feature with value 1 to the end of every input data. Then the bias becoms the last column of the y(x) matrix.
    ...
    # Manually computing root mean square error on the test set predictions.
...
# Finding the exact solution of the minimum value of the MSE loss function, by finding where the gradient is equal to 0 
